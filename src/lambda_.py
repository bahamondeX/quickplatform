...
class CreateFunction(BaseModel):
	function_name: str
	runtime: tp.Literal["python3.9", "python3.10", "python3.11", "python3.12", "nodejs18.x", "nodejs20.x", "java11", "java17", "java21", "dotnet6", "dotnet8", "go1.x", "ruby3.2", "ruby3.3", "provided.al2", "provided.al2023"]
	role: str
	handler: str
...
class InvokeFunction(BaseModel):
	function_name: str
	invocation_type: tp.Literal["Event", "RequestResponse", "DryRun"] = "RequestResponse"
...
class CreateEventSourceMapping(BaseModel):
	...
	amazon_managed_kafka_event_source_config: tp.Dict[str, tp.Any] = Field(default_factory=dict)
	self_managed_kafka_event_source_config: tp.Dict[str, tp.Any] = Field(default_factory=dict)
...
class LambdaClient:
	...
	def list_functions(self, function_version: str = "ALL", marker: str | None = None, max_items: int = 10000):
		params: tp.Dict[str, tp.Any] = {'FunctionVersion': function_version, 'MaxItems': max_items}
		if marker:
	...
	def publish_version(self, function_name: str, code_sha256: str | None = None, description: str = "", revision_id: str | None = None):
	...
	def list_aliases(self, function_name: str, function_version: str | None = None, marker: str | None = None, max_items: int = 10000):
		params: tp.Dict[str, tp.Any] = {'FunctionName': function_name, 'MaxItems': max_items}
		if function_version:
	...
	def create_provisioned_concurrency_config(self, config: CreateProvisionedConcurrencyConfig):
	...
	def list_versions_by_function(self, function_name: str, marker: str | None = None, max_items: int = 10000):
		params: tp.Dict[str, tp.Any] = {'FunctionName': function_name, 'MaxItems': max_items}
	...
	def get_function_configuration(self, function_name: str, qualifier: str | None = None):
	...
	def get_function_code_signing_config(self, function_name: str):
		response = self.lambda_client.get_function_code_signing_config(FunctionName=function_name)
		return response
	...
	def update_event_source_mapping(self, config: UpdateEventSourceMapping):
		...
		if config.maximum_batching_window_in_seconds:
			params['MaximumBatchingWindowInSeconds'] = config.maximum_batching_window_in_seconds
		...
		if config.document_db_event_source_config:
			params['DocumentDBEventSourceConfig'] = config.document_db_event_source_config
		
		response = self.lambda_client.update_event_source_mapping(**params)
		return response

	def list_event_source_mappings(self, event_source_arn: str | None = None, function_name: str | None = None, marker: str | None = None, max_items: int = 10000):
	...
	def get_code_signing_config(self, code_signing_config_arn: str):
		response = self.lambda_client.get_code_signing_config(CodeSigningConfigArn=code_signing_config_arn)
		return response

	def delete_code_signing_config(self, code_signing_config_arn: str):
		response = self.lambda_client.delete_code_signing_config(CodeSigningConfigArn=code_signing_config_arn)
		return response

	def update_code_signing_config(self, config: CodeSigningConfig):
		params: tp.Dict[str, tp.Any] = {'CodeSigningConfigArn': config.code_signing_config_arn}
	...
	def list_code_signing_configs(self, marker: str | None = None, max_items: int = 10000):
		params: tp.Dict[str, tp.Any] = {'MaxItems': max_items}
		if marker:
			params['Marker'] = marker
	...
	def delete_function_concurrency(self, function_name: str):
		response = self.lambda_client.delete_function_concurrency(FunctionName=function_name)
		return response

	def put_function_concurrency(self, function_name: str, reserved_concurrent_executions: int):
	...
	def list_provisioned_concurrency_configs(self, function_name: str, marker: str | None = None, max_items: int = 10000):
		params: tp.Dict[str, tp.Any] = {'FunctionName': function_name, 'MaxItems': max_items}
		if marker:
			params['Marker'] = marker
	...
	def put_provisioned_concurrency_config(self, function_name: str, qualifier: str, provisioned_concurrent_executions: int):
		response = self.lambda_client.put_provisioned_concurrency_config(
			FunctionName=function_name,
			Qualifier=qualifier,
	...
	def delete_function_url_config(self, function_name: str, qualifier: str | None = None):
		params: tp.Dict[str, tp.Any] = {'FunctionName': function_name}
		if qualifier:
			params['Qualifier'] = qualifier
	...
	def update_function_url_config(self, function_name: str, config: tp.Dict[str, tp.Any], qualifier: str | None = None):
	...
	def create_function_url_config(self, function_name: str, config: tp.Dict[str, tp.Any], qualifier: str | None = None):
		params: tp.Dict[str, tp.Any] = {'FunctionName': function_name, 'Config': config}
		if qualifier:
			params['Qualifier'] = qualifier
	...
	def remove_permission(self, function_name: str, statement_id: str, qualifier: str | None = None, revision_id: str | None = None):
		params: tp.Dict[str, tp.Any] = {'FunctionName': function_name, 'StatementId': statement_id}
		if qualifier:
			params['Qualifier'] = qualifier
		if revision_id:
			params['RevisionId'] = revision_id
	...
	def list_layers(self, compatible_runtime: str | None = None, compatible_architecture: str | None = None, marker: str | None = None, max_items: int = 50):
		params: tp.Dict[str, tp.Any] = {'MaxItems': max_items}
	...
	def get_layer_version(self, layer_name: str, version_number: int):
		response = self.lambda_client.get_layer_version(LayerName=layer_name, VersionNumber=version_number)
		return response

	def delete_layer_version(self, layer_name: str, version_number: int):
		response = self.lambda_client.delete_layer_version(LayerName=layer_name, VersionNumber=version_number)
		return response

	def list_layer_versions(self, layer_name: str, compatible_runtime: str | None = None, compatible_architecture: str | None = None, marker: str | None = None, max_items: int = 50):
...
async def list_functions(function_version: str = "ALL", marker: str | None = None, max_items: int = 10000):
	try:
...
async def update_function_configuration(function_name: str, config: UpdateFunctionConfiguration):
	config.function_name = function_name
	try:
...
async def list_event_source_mappings(event_source_arn: str | None = None, function_name: str | None = None, marker: str | None = None, max_items: int = 10000):
	try:
		response = client.list_event_source_mappings(event_source_arn, function_name, marker, max_items)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))
...
async def update_code_signing_config(code_signing_config_arn: str, config: CodeSigningConfig):
...
async def put_function_concurrency_endpoint(function_name: str, config: PutFunctionConcurrency):
	config.function_name = function_name
	try:
		response = client.put_function_concurrency(config.function_name, config.reserved_concurrent_executions)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))


@app.get("/api/v1/functions/{function_name}/provisioned-concurrency-configs/{qualifier}")
async def get_provisioned_concurrency_config_endpoint(function_name: str, qualifier: str):
	try:
...
@app.delete("/api/v1/functions/{function_name}/provisioned-concurrency-configs/{qualifier}")
async def delete_provisioned_concurrency_config_endpoint(function_name: str, qualifier: str):
	try:
		response = client.delete_provisioned_concurrency_config(function_name, qualifier)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))
...
async def list_provisioned_concurrency_configs_endpoint(function_name: str, marker: str | None = None, max_items: int = 10000):
	try:
		response = client.list_provisioned_concurrency_configs(function_name, marker, max_items)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))
...
async def put_provisioned_concurrency_config(function_name: str, config: CreateProvisionedConcurrencyConfig):
	config.function_name = function_name
	try:
...
async def get_function_url_config_endpoint(function_name: str, qualifier: str | None = None):
	try:
...
async def delete_function_url_config_endpoint(function_name: str, qualifier: str | None = None):
	try:
...
async def update_function_url_config_endpoint(function_name: str, config: tp.Dict[str, tp.Any], qualifier: str | None = None):
	try:
...
async def create_function_url_config_endpoint(function_name: str, config: CreateFunctionUrlConfig):
	config.function_name = function_name
	try:
		response = client.create_function_url_config(config.function_name, config.config, config.qualifier)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))
...
async def remove_permission_endpoint(function_name: str, statement_id: str, qualifier: str | None = None, revision_id: str | None = None):
	try:
		response = client.remove_permission(function_name, statement_id, qualifier, revision_id)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))
...
async def list_layers_endpoint(compatible_runtime: str | None = None, compatible_architecture: str | None = None, marker: str | None = None, max_items: int = 50):
	try:
		response = client.list_layers(compatible_runtime, compatible_architecture, marker, max_items)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))
...
async def list_layer_versions_endpoint(layer_name: str, compatible_runtime: str | None = None, compatible_architecture: str | None = None, marker: str | None = None, max_items: int = 50):
	try:
...
async def publish_version(function_name: str, code_sha256: str | None = None, description: str = "", revision_id: str | None = None):
	try:
		response = client.publish_version(function_name, code_sha256, description, revision_id)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))
...
async def list_versions_by_function(function_name: str, marker: str | None = None, max_items: int = 10000):
	try:
...
async def list_aliases(function_name: str, function_version: str | None = None, marker: str | None = None, max_items: int = 10000):
	try:
		response = client.list_aliases(function_name, function_version, marker, max_items)
		return response
	except ClientError as e:
		raise HTTPException(status_code=400, detail=str(e))
...
@app.get("/api/v1/layers")
async def list_layers(compatible_runtime: str | None = None, compatible_architecture: str | None = None, marker: str | None = None, max_items: int = 50):
	try:
		response = client.list_layers(compatible_runtime, compatible_architecture, marker, max_items)
		return response
	except ClientError as e:
...
@app.get("/api/v1/layers/{layer_name}/versions")
async def list_layer_versions(layer_name: str, compatible_runtime: str | None = None, compatible_architecture: str | None = None, marker: str | None = None, max_items: int = 50):
	try:
		response = client.list_layer_versions(
			layer_name, compatible_runtime, compatible_architecture, marker, max_items
		)
...
@app.delete("/api/v1/functions/{function_name}/permissions/{statement_id}")
async def remove_permission(function_name: str, statement_id: str, qualifier: str | None = None, revision_id: str | None = None):
    result = client.remove_permission(function_name, statement_id, qualifier, revision_id)
    if result:
...
@app.post("/api/v1/functions/{function_name}/url-configs")
async def create_function_url_config(function_name: str, config: CreateFunctionUrlConfig):
    config.function_name = function_name
    try:
        response = client.create_function_url_config(config.function_name, config.config, config.qualifier)
        return response
...
@app.put("/api/v1/functions/{function_name}/url-configs")
async def update_function_url_config(function_name: str, config: tp.Dict[str, tp.Any], qualifier: str | None = None):
    try:
        response = client.update_function_url_config(function_name, config, qualifier)
        return response
    except ClientError as e:
...
async def create_provisioned_concurrency_config(function_name: str, config: CreateProvisionedConcurrencyConfig):
    config.function_name = function_name
    try:
...
async def delete_provisioned_concurrency_config(function_name: str, qualifier: str):
    ...
    raise HTTPException(status_code=400, detail="Failed to delete provisioned concurrency config")
...
@app.get("/api/v1/functions/{function_name}/provisioned-concurrency-configs")
async def list_provisioned_concurrency_configs(function_name: str, marker: str | None = None, max_items: int = 50):
    try:
        response = client.list_provisioned_concurrency_configs(function_name, marker, max_items)
        return response
    except ClientError as e:
